  ...
  >
    ...
    <div class="flex justify-between items-center mt-3">
      <router-link
        ...
        class="flex px-4 py-2 border border-transparent text-sm rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
      >
        <svg
      ...
      <div class="flex items-center space-x-1">
        ...
        <button
          ...
          class="h-8 w-8 flex items-center justify-center rounded-full border border-transparent text-sm text-rose-500 focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
